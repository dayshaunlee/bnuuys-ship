...
void PhysicsSystem::step(float elapsed_ms) {
    // Move each entity that has motion (invaders, projectiles, and even towers
    // [they have 0 for velocity]) based on how much time has passed, this is to
    // (partially) avoid having entities move at different speed based on the
    // machine.
